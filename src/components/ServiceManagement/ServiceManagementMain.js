...
import manageImg1 from '../../assets/img/bg/11.png'
import manageImg2 from '../../assets/img/bg/002.jpg'
import pricingIcon1 from '../../assets/img/icon/p-1.png'
import pricingIcon2 from '../../assets/img/icon/p-2.png'
import pricingIcon3 from '../../assets/img/icon/p-3.png'

import bgImg1 from '../../assets/img/bg-16.jpg';
import bgImg2 from '../../assets/img/bg-10.jpg';
...
const ServiceManagementMain = () => {
    return (
        <React.Fragment>
            ...
            <div className="it-management-area pt-130 pb-100" style={bgStyle1}>
                <div className="container">
                    <div className="row">
                        <div className="col-xl-6 col-lg-6 mb-30">
                            <div className="it-management-img">
                                <img src={manageImg2} alt="" />
                            </div>
                        </div>
                        <div className="col-xl-6 col-lg-6 mb-30">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                            <div className="single-services text-center">
                                ...
                                <div className="services-text">
                                    ...
                                    <a href="#"> <span className="services-button">read more <i className="fa fa-long-arrow-right"></i></span> </a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
            ...
            {/* <!-- pricing-area-start --> */}
            <div className="pricing-area pt-100 pb-100" style={bgStyle2}>
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="pricing-wrapper text-center mb-30">
                                ...
                                <div className="pricing-button">
                                    <a href="#"> <span className="pricings-button">select plan <i className="fa fa-long-arrow-right"></i></span> </a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-4 col-md-6">
